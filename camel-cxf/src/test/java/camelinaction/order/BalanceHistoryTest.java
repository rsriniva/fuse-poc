...
public class BalanceHistoryTest {
    private static final Logger LOG = LoggerFactory.getLogger(BalanceHistoryTest.class);
    ...
    public void sendRequest() throws Exception {
         ...
         */
        URLConnection connection = new URL("http://localhost:8181/cxf/balancehistory").openConnection();
        ...
        InputStream fis = BalanceHistoryTest.class.getResourceAsStream("/request-balance-history.xml");
