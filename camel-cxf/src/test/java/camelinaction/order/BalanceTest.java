...
public class BalanceTest {
    ...
    public void sendRequest() throws Exception {
         ...
         */
        URLConnection connection = new URL("http://localhost:8181/cxf/balance").openConnection();
        ...
        InputStream fis = BalanceTest.class.getResourceAsStream("/request-balance.xml");
